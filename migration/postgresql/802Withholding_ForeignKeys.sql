...
ALTER TABLE LVE_Withholding ADD CONSTRAINT FK_Withholding_DocType FOREIGN KEY (WithholdingDocType_ID)
REFERENCES C_DocType (C_DocType_ID)
ON UPDATE CASCADE
ON DELETE RESTRICT;

ALTER TABLE LVE_Withholding ADD CONSTRAINT FK_Withholding_DocType FOREIGN KEY (DeclarationDocType_ID)
REFERENCES C_DocType (C_DocType_ID)
ON UPDATE CASCADE
ON DELETE RESTRICT;
