...
-- LVE Withholding
UPDATE AD_Column SET IsAlwaysUpdateable='Y', IsUpdateable='Y',Updated=TO_DATE('2013-09-16 11:42:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66406
;
...
AND NOT EXISTS(SELECT 1 FROM LVE_Withholding wh WHERE wh.WithholdingDocType_ID = C_Invoice.C_DocType_ID)',TO_DATE('2013-09-16 11:55:55','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','C_Invoice of C_BPartner And Not Withholding Applied','S',TO_DATE('2013-09-16 11:55:55','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Sep 16, 2013 11:56:58 AM VET
-- LVE Withholding
UPDATE AD_Process_Para SET AD_Val_Rule_ID=52208,Updated=TO_DATE('2013-09-16 11:56:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53935
;
