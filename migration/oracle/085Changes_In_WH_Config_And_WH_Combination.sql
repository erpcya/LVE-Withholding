...
-- LVE Withholding
ALTER TABLE LVE_WH_Combination ADD IsManual CHAR(1) DEFAULT NULL  CHECK (IsManual IN ('Y','N'))
;
...
-- LVE Withholding
ALTER TABLE LVE_WH_Config ADD MinValue NUMBER NOT NULL
;
...
-- LVE Withholding
ALTER TABLE LVE_WH_Config ADD MaxValue NUMBER NOT NULL
;
