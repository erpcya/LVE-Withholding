...
-- LVE Withholding
UPDATE C_Charge SET ChargeAmt=1.000000000000, Name='RETETENCIÓN I.S.L.R.',Updated=TO_TIMESTAMP('2013-08-01 16:58:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_Charge_ID=1000000
;
...
-- LVE Withholding
INSERT INTO C_Charge (AD_Client_ID,AD_Org_ID,C_Charge_ID,C_TaxCategory_ID,ChargeAmt,Created,CreatedBy,IsActive,IsSameCurrency,IsSameTax,IsTaxIncluded,Name,Updated,UpdatedBy) VALUES (11,50001,1000001,1000000,1.000000000000,TO_TIMESTAMP('2013-08-01 16:58:54','YYYY-MM-DD HH24:MI:SS'),100,'Y','N','N','N','RETETENCIÓN I.V.A.',TO_TIMESTAMP('2013-08-01 16:58:54','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
UPDATE C_DocType SET GL_Category_ID=112,Updated=TO_TIMESTAMP('2013-08-01 17:00:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000000
;

-- 1/08/2013 05:01:05 PM VET
-- LVE Withholding
UPDATE C_DocType SET DocumentCopies=0,Updated=TO_TIMESTAMP('2013-08-01 17:01:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000003
;

-- 1/08/2013 05:01:14 PM VET
-- LVE Withholding
UPDATE C_DocType SET DocumentCopies=0,Updated=TO_TIMESTAMP('2013-08-01 17:01:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000000
;

-- 1/08/2013 05:02:48 PM VET
-- LVE Withholding
INSERT INTO C_DocType (AD_Client_ID,AD_Org_ID,C_DocType_ID,Created,CreatedBy,DocBaseType,DocNoSequence_ID,DocumentCopies,GL_Category_ID,HasCharges,HasProforma,IsActive,IsCreateCounter,IsDefault,IsDefaultCounterDoc,IsDocNoControlled,IsIndexed,IsInTransit,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,IsPickQAConfirm,IsPrepareSplitDocument,IsShipConfirm,IsSOTrx,IsSplitWhenDifference,Name,PrintName,Updated,UpdatedBy) VALUES (11,0,1000004,TO_TIMESTAMP('2013-08-01 17:02:48','YYYY-MM-DD HH24:MI:SS'),100,'API',1000001,1,112,'N','N','Y','Y','N','N','Y','Y','N','N','N','N','Y','N','N','N','CXP-Declaracion Impuesto (db)','DECLARACION IMPUESTO',TO_TIMESTAMP('2013-08-01 17:02:48','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
INSERT INTO LVE_WH_Concept (AD_Client_ID,AD_Org_ID,Created,CreatedBy,Description,IsActive,LVE_Withholding_ID,LVE_WH_Concept_ID,Name,Updated,UpdatedBy) VALUES (11,50001,TO_TIMESTAMP('2013-08-01 17:06:39','YYYY-MM-DD HH24:MI:SS'),100,'IVA 75','Y',1000001,1000016,'IVA 75',TO_TIMESTAMP('2013-08-01 17:06:39','YYYY-MM-DD HH24:MI:SS'),100)
;
