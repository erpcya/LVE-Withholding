...
INSERT INTO LVE_WH_Type (AD_Client_ID,AD_Org_ID,Created,CreatedBy,Description,IsActive,LVE_WH_Type_ID,Name,Updated,UpdatedBy,Value) VALUES (11,0,TO_DATE('2013-08-26 12:05:46','YYYY-MM-DD HH24:MI:SS'),100,'RETENCION DE IMPUESTO MUNICIPAL
','Y',1000003,'RETENCION DE IMPUESTO MUNICIPAL',TO_DATE('2013-08-26 12:05:46','YYYY-MM-DD HH24:MI:SS'),100,'RISLR')
;

-- 26/08/2013 12:06:32 PM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE LVE_WH_Type SET Value='RIM',Updated=TO_DATE('2013-08-26 12:06:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE LVE_WH_Type_ID=1000003
;

-- 26/08/2013 12:07:10 PM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO C_Charge (AD_Client_ID,AD_Org_ID,C_Charge_ID,ChargeAmt,Created,CreatedBy,C_TaxCategory_ID,IsActive,IsSameCurrency,IsSameTax,IsTaxIncluded,Name,Updated,UpdatedBy) VALUES (11,0,1000002,0,TO_DATE('2013-08-26 12:07:10','YYYY-MM-DD HH24:MI:SS'),100,1000000,'Y','N','N','N','RETENCION DE IMPUESTO MUNICIPAL',TO_DATE('2013-08-26 12:07:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO LVE_WH_ConceptGroup (AD_Client_ID,AD_Org_ID,Created,CreatedBy,Description,IsActive,LVE_WH_ConceptGroup_ID,Name,Updated,UpdatedBy,Value) VALUES (11,0,TO_DATE('2013-08-26 12:07:55','YYYY-MM-DD HH24:MI:SS'),100,'GRUPO DE RETENCION IMPUESTO MUNICIPAL
','Y',1000003,'RETENCION IMPUESTO MUNICIPAL',TO_DATE('2013-08-26 12:07:55','YYYY-MM-DD HH24:MI:SS'),100,'RETENCION IMPUESTO MUNICIPAL')
;

-- 26/08/2013 12:09:04 PM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNewYear,StartNo,Updated,UpdatedBy) VALUES (11,0,1000027,TO_DATE('2013-08-26 12:09:03','YYYY-MM-DD HH24:MI:SS'),100,1,100,1,'Y','N','Y','N','RETENCION DE IMPUESTO MUNICIPAL','N',1000000,TO_DATE('2013-08-26 12:09:03','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 26/08/2013 12:10:41 PM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO C_DocType (AD_Client_ID,AD_Org_ID,AD_PrintFormat_ID,C_DocType_ID,Created,CreatedBy,DocBaseType,DocNoSequence_ID,DocumentCopies,GL_Category_ID,HasCharges,HasProforma,IsActive,IsCreateCounter,IsDefault,IsDefaultCounterDoc,IsDocNoControlled,IsIndexed,IsInTransit,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,IsPickQAConfirm,IsPrepareSplitDocument,IsShipConfirm,IsSOTrx,IsSplitWhenDifference,Name,PrintName,Updated,UpdatedBy) VALUES (11,0,50110,1000004,TO_DATE('2013-08-26 12:10:41','YYYY-MM-DD HH24:MI:SS'),100,'APC',1000027,0,112,'N','N','Y','Y','N','N','Y','Y','N','N','N','N','Y','N','N','N','RETENCION DE IMPUESTO MUNICIPAL','RETENCION DE IMPUESTO MUNICIPAL',TO_DATE('2013-08-26 12:10:41','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,Prefix,StartNewYear,StartNo,Updated,UpdatedBy) VALUES (11,0,1000028,TO_DATE('2013-08-26 12:11:39','YYYY-MM-DD HH24:MI:SS'),100,1,100,1,'Y','N','Y','N','DECLARACION DE IMPUESTO MUNICIPAL','ADCR-','N',1000000,TO_DATE('2013-08-26 12:11:39','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 26/08/2013 12:12:04 PM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO C_DocType (AD_Client_ID,AD_Org_ID,C_DocType_ID,Created,CreatedBy,DocBaseType,DocNoSequence_ID,DocumentCopies,GL_Category_ID,HasCharges,HasProforma,IsActive,IsCreateCounter,IsDefault,IsDefaultCounterDoc,IsDocNoControlled,IsIndexed,IsInTransit,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,IsPickQAConfirm,IsPrepareSplitDocument,IsShipConfirm,IsSOTrx,IsSplitWhenDifference,Name,PrintName,Updated,UpdatedBy) VALUES (11,0,1000005,TO_DATE('2013-08-26 12:12:03','YYYY-MM-DD HH24:MI:SS'),100,'API',1000028,0,112,'N','N','Y','Y','N','Y','Y','Y','N','N','N','N','Y','N','N','N','DECLARACION DE IMPUESTO MUNICIPAL','DECLARACION DE IMPUESTO MUNICIPAL',TO_DATE('2013-08-26 12:12:03','YYYY-MM-DD HH24:MI:SS'),100)
;
