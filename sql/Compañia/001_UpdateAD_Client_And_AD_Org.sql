...
UPDATE C_PaysChedule SET AD_Client_ID = 1000002, AD_Org_ID =0;


SELECT * FROM AD_PrintFormat WHERE AD_PrintFormat_ID IN (3000205,3000206,3000202,3000201,3000207,3000208,3000212,3000215);
UPDATE AD_PrintFormat SET AD_Client_ID = 1000002, AD_Org_ID = 0 WHERE AD_PrintFormat_ID IN (3000205,3000206,3000202,3000201,3000207,3000208,3000212,3000215);

SELECT * FROM AD_PrintFormatItem WHERE AD_PrintFormat_ID IN (3000205,3000206,3000202,3000201,3000207,3000208,3000212,3000215);
UPDATE AD_PrintFormatItem SET AD_Client_ID = 1000002, AD_Org_ID = 0 WHERE AD_PrintFormat_ID IN (3000205,3000206,3000202,3000201,3000207,3000208,3000212,3000215);
