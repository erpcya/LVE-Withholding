...
-- LVE Withholding
INSERT INTO AD_Rule (AD_Client_ID,AD_Org_ID,AD_Rule_ID,Created,CreatedBy,EntityType,EventType,IsActive,Name,RuleType,Script,Updated,UpdatedBy,Value) VALUES (0,0,50017,TO_DATE('2013-08-20 18:24:10','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','P','Y','I.S.L.R','S','//  O_LVE_Withholding          = Withholding
...
//  Result
result=wh_Amt;',TO_DATE('2013-08-20 18:24:10','YYYY-MM-DD HH24:MI:SS'),100,'groovy:ISLR')
;

-- Aug 20, 2013 6:27:25 PM VET
-- LVE Withholding
UPDATE LVE_Withholding SET AD_Rule_ID=50017,Updated=TO_DATE('2013-08-20 18:27:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE LVE_Withholding_ID=1000000
;
