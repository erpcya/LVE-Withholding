...
// N
	...
	public void setCUST_PersonType_ID (BigDecimal CUST_PersonType_ID)
	{
		set_Value (COLUMNNAME_CUST_PersonType_ID, CUST_PersonType_ID);
	}

	/** Get Person Type.
		@return Person Type	  */
	public BigDecimal getCUST_PersonType_ID () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_CUST_PersonType_ID);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
