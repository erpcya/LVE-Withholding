...
-- LVE Withholding
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56104,0,'Beneficiary_ID',TO_DATE('2013-08-10 21:41:44','YYYY-MM-DD HH24:MI:SS'),100,'Business Partner to whom payment is made','ECA02','The Beneficiary indicates the Business Partner to whom payment will be made.  This field is only displayed if the Paid to Third Party checkbox is selected.','Y','Beneficiary','Beneficiary',TO_DATE('2013-08-10 21:41:44','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
UPDATE AD_Element_Trl SET Name='Beneficiario',PrintName='Beneficiario',Description='Socio del Negocio a quién se hace el pago',Help='El beneficiario indica el socio del negocio a quién se hará el pago.',Updated=TO_DATE('2013-08-10 21:42:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56104 AND AD_Language='es_MX'
;

-- Aug 10, 2013 9:42:43 PM VET
-- LVE Withholding
UPDATE AD_Element SET Help='The Beneficiary indicates the Business Partner to whom payment will be made.',Updated=TO_DATE('2013-08-10 21:42:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56104
;
...
-- LVE Withholding
UPDATE AD_Column SET AD_Element_ID=56104, AD_Reference_ID=30, AD_Reference_Value_ID=192, ColumnName='Beneficiary_ID', Description='Business Partner to whom payment is made', Help='The Beneficiary indicates the Business Partner to whom payment will be made.', Name='Beneficiary',Updated=TO_DATE('2013-08-10 21:43:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66406
;
