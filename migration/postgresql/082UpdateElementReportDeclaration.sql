...
-- LVE Withholding
UPDATE AD_Element SET ColumnName='BCTaxID',Updated=TO_TIMESTAMP('2013-08-13 14:29:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56094
;
...
-- LVE Withholding
UPDATE AD_PrintFormatItem SET AD_Column_ID=66586, IsGroupBy='N', IsPageBreak='N', SortNo=0, XPosition=0, YPosition=0,Updated=TO_TIMESTAMP('2013-08-13 14:31:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_PrintFormatItem_ID=54023
;
