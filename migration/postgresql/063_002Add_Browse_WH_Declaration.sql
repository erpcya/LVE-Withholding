...
-- LVE Withholding
UPDATE AD_View_Trl SET Name='Retenciones no Declaradas',Description='Retenciones no Declaradas',Help='Vista de retenciones pendientes por declarar.',Updated=TO_TIMESTAMP('2013-08-09 06:11:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_View_ID=50015
;

-- Aug 9, 2013 6:12:39 AM VET
-- LVE Withholding
INSERT INTO AD_View_Definition (AD_Client_ID,AD_Org_ID,AD_Table_ID,AD_View_Definition_ID,AD_View_ID,Created,CreatedBy,IsActive,Processing,SeqNo,TableAlias,Updated,UpdatedBy) VALUES (0,0,53547,50052,50015,TO_TIMESTAMP('2013-08-09 06:12:38','YYYY-MM-DD HH24:MI:SS'),100,'Y','N',10,'WHU',TO_TIMESTAMP('2013-08-09 06:12:38','YYYY-MM-DD HH24:MI:SS'),100)
;
