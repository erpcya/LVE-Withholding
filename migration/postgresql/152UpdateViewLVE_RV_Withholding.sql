...
-- LVE Withholding
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56597,0,'whbaseamt',TO_TIMESTAMP('2013-11-07 11:41:57','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','whbaseamt','whbaseamt',TO_TIMESTAMP('2013-11-07 11:41:57','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsTranslated,IsUpdateable,Name,Updated,UpdatedBy,Version) VALUES (0,69830,56597,0,12,53542,'whbaseamt',TO_TIMESTAMP('2013-11-07 11:41:57','YYYY-MM-DD HH24:MI:SS'),100,'ECA02',131089,'Y','N','N','N','N','N','N','N','N','N','whbaseamt',TO_TIMESTAMP('2013-11-07 11:41:57','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- LVE Withholding
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56598,0,'whtaxamt',TO_TIMESTAMP('2013-11-07 11:42:00','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','whtaxamt','whtaxamt',TO_TIMESTAMP('2013-11-07 11:42:00','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsTranslated,IsUpdateable,Name,Updated,UpdatedBy,Version) VALUES (0,69831,56598,0,12,53542,'whtaxamt',TO_TIMESTAMP('2013-11-07 11:42:00','YYYY-MM-DD HH24:MI:SS'),100,'ECA02',131089,'Y','N','N','N','N','N','N','N','N','N','whtaxamt',TO_TIMESTAMP('2013-11-07 11:42:00','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- LVE Withholding
UPDATE AD_Element SET ColumnName='WHBaseAmt', Name='WH Base Amt', PrintName='WH Base Amt',Updated=TO_TIMESTAMP('2013-11-07 11:43:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56597
;
...
-- Nov 7, 2013 11:43:50 AM VET
-- LVE Withholding
UPDATE AD_PrintFormatItem SET PrintName='WH Base Amt', Name='WH Base Amt' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=56597)
;

-- Nov 7, 2013 11:45:23 AM VET
-- LVE Withholding
UPDATE AD_Element SET Name='Withholding Base Amt', PrintName='Withholding Base Amt',Updated=TO_TIMESTAMP('2013-11-07 11:45:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56597
;
...
-- Nov 7, 2013 11:45:23 AM VET
-- LVE Withholding
UPDATE AD_PrintFormatItem SET PrintName='Withholding Base Amt', Name='Withholding Base Amt' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=56597)
;

-- Nov 7, 2013 11:46:09 AM VET
-- LVE Withholding
UPDATE AD_Element_Trl SET Name='Monto Base Retenido',PrintName='Monto Base Retenido',Updated=TO_TIMESTAMP('2013-11-07 11:46:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56597 AND AD_Language='es_MX'
;

-- Nov 7, 2013 11:48:32 AM VET
-- LVE Withholding
UPDATE AD_Element SET ColumnName='WHTaxAmt', Name='Withholding Tax Amt', PrintName='Withholding Tax Amt',Updated=TO_TIMESTAMP('2013-11-07 11:48:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56598
;
...
-- Nov 7, 2013 11:48:32 AM VET
-- LVE Withholding
UPDATE AD_PrintFormatItem SET PrintName='Withholding Tax Amt', Name='Withholding Tax Amt' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=56598)
;

-- Nov 7, 2013 11:48:45 AM VET
-- LVE Withholding
UPDATE AD_Element_Trl SET Name='Impuesto Retenido',PrintName='Impuesto Retenido',Updated=TO_TIMESTAMP('2013-11-07 11:48:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56598 AND AD_Language='es_MX'
;
