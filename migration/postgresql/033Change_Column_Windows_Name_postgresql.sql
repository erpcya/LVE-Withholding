...
-- LVE Withholding
UPDATE AD_Window SET Name='LVE Withholding',Updated=TO_TIMESTAMP('2013-07-31 08:24:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=53254
;
...
-- 31/07/2013 08:24:06 AM VET
-- LVE Withholding
UPDATE AD_Menu SET Description=NULL, IsActive='Y', Name='LVE Withholding',Updated=TO_TIMESTAMP('2013-07-31 08:24:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53573
;
...
-- LVE Withholding
UPDATE AD_Menu_Trl SET Name='Retención',Updated=TO_TIMESTAMP('2013-07-31 08:24:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53573 AND AD_Language='es_MX'
;
...
-- LVE Withholding
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,66493,67956,0,224,TO_TIMESTAMP('2013-07-31 08:28:16','YYYY-MM-DD HH24:MI:SS'),100,0,'U','Y','Y','Y','N','N','N','N','N','Person Type',130,0,TO_TIMESTAMP('2013-07-31 08:28:16','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2013-07-31 08:31:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=67956
;

-- 31/07/2013 08:33:10 AM VET
-- LVE Withholding
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2013-07-31 08:33:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=67864
;
...
-- LVE Withholding
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2013-07-31 08:35:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=67934
;

-- 31/07/2013 08:36:23 AM VET
-- LVE Withholding
UPDATE AD_Field SET DisplayLogic='@LVE_WithholdingConfig_ID@!0',Updated=TO_TIMESTAMP('2013-07-31 08:36:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=67937
;

-- 31/07/2013 08:37:57 AM VET
-- LVE Withholding
UPDATE AD_Field SET DisplayLogic='@DocAffected@!0',Updated=TO_TIMESTAMP('2013-07-31 08:37:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=67934
;

-- 31/07/2013 08:38:11 AM VET
-- LVE Withholding
UPDATE AD_Column SET ColumnName='DocAffected',Updated=TO_TIMESTAMP('2013-07-31 08:38:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66490
;

-- 31/07/2013 08:38:17 AM VET
-- LVE Withholding
UPDATE AD_Element SET ColumnName='DocAffected',Updated=TO_TIMESTAMP('2013-07-31 08:38:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56067
;
...
-- LVE Withholding
UPDATE AD_Field SET AD_FieldGroup_ID=104,Updated=TO_TIMESTAMP('2013-07-31 08:39:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=67934
;

-- 31/07/2013 08:39:46 AM VET
-- LVE Withholding
UPDATE AD_Field SET AD_FieldGroup_ID=104,Updated=TO_TIMESTAMP('2013-07-31 08:39:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=67861
;

-- 31/07/2013 08:41:02 AM VET
-- LVE Withholding
UPDATE AD_Column SET AD_Reference_Value_ID=336,Updated=TO_TIMESTAMP('2013-07-31 08:41:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66490
;
