...
/** Generated Model for LVE_WithholdingType
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_LVE_WithholdingType extends PO implements I_LVE_WithholdingType, I_Persistent 
{
    ...
    /** Load Constructor */
    public X_LVE_WithholdingType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LVE_WithholdingType[")
	...
	public void setLVE_WithholdingType_ID (int LVE_WithholdingType_ID)
	{
		if (LVE_WithholdingType_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_LVE_WithholdingType_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_LVE_WithholdingType_ID, Integer.valueOf(LVE_WithholdingType_ID));
	}
