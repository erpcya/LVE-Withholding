...
AND NOT EXISTS(SELECT 1 FROM LVE_Withholding wh WHERE wh.WithholdingDocType_ID = C_Invoice.C_DocType_ID)',Updated=TO_DATE('2013-10-24 11:44:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52208
;
