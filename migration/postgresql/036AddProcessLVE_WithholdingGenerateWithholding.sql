...
-- LVE Withholding
UPDATE AD_Process_Trl SET Name='Generar Retención',Description='Generar Retención',Updated=TO_TIMESTAMP('2013-07-31 11:03:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53424 AND AD_Language='es_MX'
;
...
-- 31/07/2013 11:04:48 AM VET
-- LVE Withholding
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 100,t.AD_Tree_ID, 53579, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53579)
;

-- 31/07/2013 11:05:01 AM VET
-- LVE Withholding
UPDATE AD_Menu_Trl SET Name='Generar Retención',Description='Generar Retención',Updated=TO_TIMESTAMP('2013-07-31 11:05:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53579 AND AD_Language='es_MX'
;

-- 31/07/2013 11:05:05 AM VET
-- LVE Withholding
UPDATE AD_TreeNodeMM SET Parent_ID=53572, SeqNo=0, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53579
;

-- 31/07/2013 11:05:05 AM VET
-- LVE Withholding
UPDATE AD_TreeNodeMM SET Parent_ID=53572, SeqNo=1, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53578
;

-- 31/07/2013 11:05:05 AM VET
-- LVE Withholding
UPDATE AD_TreeNodeMM SET Parent_ID=53572, SeqNo=2, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53577
;
...
-- LVE Withholding
UPDATE AD_Element_Trl SET Name='Tipo de Retención',PrintName='Tipo de Retención',Updated=TO_TIMESTAMP('2013-07-31 11:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56052 AND AD_Language='es_MX'
;

-- 31/07/2013 11:21:07 AM VET
-- LVE Withholding
UPDATE AD_Process_Para SET IsMandatory='Y',Updated=TO_TIMESTAMP('2013-07-31 11:21:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53933
;
