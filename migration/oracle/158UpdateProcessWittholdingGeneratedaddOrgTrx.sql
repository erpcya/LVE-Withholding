...
-- LVE Withholding
UPDATE AD_Process_Para SET SeqNo=5,Updated=TO_DATE('2013-12-19 09:23:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=54283
;

-- Dec 19, 2013 9:23:18 AM VET
-- LVE Withholding
UPDATE AD_Process_Para SET SeqNo=9,Updated=TO_DATE('2013-12-19 09:23:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=54326
;
