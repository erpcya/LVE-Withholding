...
-- LVE Retention
CREATE TABLE CUST_RetentionType (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, AD_Rule_ID NUMERIC DEFAULT NULL , AD_Process_ID NUMERIC(10) DEFAULT NULL , Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, CUST_RetentionType_ID NUMERIC(10) NOT NULL, Description VARCHAR(255) DEFAULT NULL , IsActive CHAR(1) CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR(60) NOT NULL , Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, IsSOTrx CHAR(1) DEFAULT 'N' CHECK (IsSOTrx IN ('Y','N')), C_Charge_ID NUMERIC(10) DEFAULT NULL, C_DocType_ID NUMERIC(10) DEFAULT NULL, CONSTRAINT CUST_RetentionType_Key PRIMARY KEY (CUST_RetentionType_ID))
;
