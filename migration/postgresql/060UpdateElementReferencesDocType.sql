...
-- LVE Withholding
UPDATE AD_Element SET ColumnName='WithholdingDocType_ID',Updated=TO_TIMESTAMP('2013-08-08 16:45:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56054
;
...
-- LVE Withholding
UPDATE AD_Element SET ColumnName='DeclarationDocType_ID',Updated=TO_TIMESTAMP('2013-08-08 16:47:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56055
;
...
-- LVE Withholding
UPDATE AD_Element SET ColumnName='RifOrg',Updated=TO_TIMESTAMP('2013-08-08 16:48:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56096
;
...
-- LVE Withholding
UPDATE AD_Element SET Name='Rif Org', PrintName='Rif Org',Updated=TO_TIMESTAMP('2013-08-08 16:48:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56096
;
...
-- Aug 8, 2013 4:48:53 PM VET
-- LVE Withholding
UPDATE AD_PrintFormatItem SET PrintName='Rif Org', Name='Rif Org' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=56096)
;
