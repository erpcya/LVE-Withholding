...
-- LVE Withholding
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,66655,566,0,11,53534,'SeqNo',TO_TIMESTAMP('2013-08-10 22:33:42','YYYY-MM-DD HH24:MI:SS'),100,'Method of ordering records; lowest number comes first','ECA02',14,'The Sequence indicates the order of records','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Sequence',0,TO_TIMESTAMP('2013-08-10 22:33:42','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- LVE Withholding
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,66655,68106,0,53717,TO_TIMESTAMP('2013-08-10 22:35:06','YYYY-MM-DD HH24:MI:SS'),100,'Method of ordering records; lowest number comes first',0,'ECA02','The Sequence indicates the order of records','Y','Y','Y','N','N','N','N','N','Sequence',150,0,TO_TIMESTAMP('2013-08-10 22:35:06','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2013-08-10 22:36:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=68077
;

-- Aug 10, 2013 10:37:51 PM VET
-- LVE Withholding
INSERT INTO AD_Tab (AD_Client_ID,AD_ColumnSortOrder_ID,AD_ColumnSortYesNo_ID,AD_Org_ID,AD_Tab_ID,AD_Table_ID,AD_Window_ID,Created,CreatedBy,EntityType,HasTree,ImportFields,IsActive,IsAdvancedTab,IsInfoTab,IsInsertRecord,IsReadOnly,IsSingleRow,IsSortTab,IsTranslationTab,Name,Processing,SeqNo,TabLevel,Updated,UpdatedBy) VALUES (0,66655,66393,0,53720,53534,53258,TO_TIMESTAMP('2013-08-10 22:37:50','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','N','N','Y','N','N','Y','N','N','Y','N','Sequence','N',30,0,TO_TIMESTAMP('2013-08-10 22:37:50','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
UPDATE AD_Tab_Trl SET Name='Secuencia',Description='Secuencia de Retenciones',Updated=TO_TIMESTAMP('2013-08-10 22:38:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53720 AND AD_Language='es_MX'
;

-- Aug 10, 2013 10:38:32 PM VET
-- LVE Withholding
UPDATE AD_Tab SET SeqNo=35,Updated=TO_TIMESTAMP('2013-08-10 22:38:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53718
;

-- Aug 10, 2013 10:38:37 PM VET
-- LVE Withholding
UPDATE AD_Tab SET SeqNo=20,Updated=TO_TIMESTAMP('2013-08-10 22:38:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53720
;

-- Aug 10, 2013 10:38:40 PM VET
-- LVE Withholding
UPDATE AD_Tab SET SeqNo=30,Updated=TO_TIMESTAMP('2013-08-10 22:38:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53718
;
