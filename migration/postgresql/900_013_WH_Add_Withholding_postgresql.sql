...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO LVE_Withholding (AD_Client_ID,AD_Org_ID,AD_Table_ID,Beneficiary_ID,C_Charge_ID,Created,CreatedBy,DeclarationDocType_ID,IsActive,IsSOTrx,LVE_WH_ConceptGroup_ID,LVE_WH_Type_ID,LVE_Withholding_ID,Name,Processing,SeqNo,TaxUnitRate,Updated,UpdatedBy,WithholdingDocType_ID) VALUES (11,50001,53556,121,1000001,TO_TIMESTAMP('2013-08-19 13:07:39','YYYY-MM-DD HH24:MI:SS'),100,1000001,'Y','N',1000001,1000001,1000003,'RETENCION DE I.V.A 75%','N',30,0,TO_TIMESTAMP('2013-08-19 13:07:39','YYYY-MM-DD HH24:MI:SS'),100,1000001)
;

-- Aug 19, 2013 1:07:52 PM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO LVE_WH_Relation (AD_Client_ID,AD_Org_ID,C_DocType_ID,Created,CreatedBy,IsActive,LVE_WH_Relation_ID,LVE_Withholding_ID,Updated,UpdatedBy) VALUES (11,50001,123,TO_TIMESTAMP('2013-08-19 13:07:52','YYYY-MM-DD HH24:MI:SS'),100,'Y',1000002,1000003,TO_TIMESTAMP('2013-08-19 13:07:52','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO LVE_WH_Relation (AD_Client_ID,AD_Org_ID,C_BPartner_ID,Created,CreatedBy,IsActive,LVE_WH_Relation_ID,LVE_Withholding_ID,Updated,UpdatedBy) VALUES (11,0,113,TO_TIMESTAMP('2013-08-19 13:08:49','YYYY-MM-DD HH24:MI:SS'),100,'Y',1000004,1000003,TO_TIMESTAMP('2013-08-19 13:08:49','YYYY-MM-DD HH24:MI:SS'),100)
;
