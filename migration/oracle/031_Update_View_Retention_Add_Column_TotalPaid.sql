...
-- LVE Retention
UPDATE AD_Element_Trl SET Name='Total Pagado',PrintName='Total Pagado',Updated=TO_DATE('2013-04-13 17:25:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000228 AND AD_Language='es_MX'
;

-- Apr 13, 2013 5:26:31 PM VET
-- LVE Retention
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,ColumnSQL,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,3000317,3000228,0,12,3000213,'TotalPaid','(''GrandTotal -  '')',TO_DATE('2013-04-13 17:26:29','YYYY-MM-DD HH24:MI:SS'),100,'ECA02',10,'Y','Y','N','N','N','N','N','N','N','N','N','N','N','Total Paid',0,TO_DATE('2013-04-13 17:26:29','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- LVE Retention
UPDATE AD_Column SET ColumnSQL='(CUST_RV_Retention.GrandTotal - CUST_RV_Retention.LineNetAmt)',Updated=TO_DATE('2013-04-13 17:27:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000317
;
