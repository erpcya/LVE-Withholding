...
UPDATE AD_Table SET Name='Withholding Combination', TableName='LVE_WH_Combination',Updated=TO_DATE('2013-08-05 02:41:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53537
;
...
-- 5/08/2013 02:42:38 AM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_PrintFormatItem pi SET PrintName='Withholding Combination', Name='Withholding Combination' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=56058)
;

-- 5/08/2013 02:42:49 AM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Combinación de Retención',PrintName='Combinación de Retención',Updated=TO_DATE('2013-08-05 02:42:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56058 AND AD_Language='es_MX'
;
